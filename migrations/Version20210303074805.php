 ...
 */
final class Version20210303074805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE data ADD adr INT DEFAULT NULL, ADD status INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE data DROP adr, DROP status');
    }
}
